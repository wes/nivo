...
import { ResponsiveBarCanvas, BarDatum, BarItemProps } from '../../../packages/bar/src'
import { AxisTickProps } from '@nivo/axes'
import React from 'react'

const meta: Meta<typeof div> = {
    title: 'ResponsiveBarCanvas',
    component: ResponsiveBarCanvas,
    tags: ['autodocs'],
    argTypes: {
...
export default meta
type Story = StoryObj<typeof ResponsiveBarCanvas>
...
const commonProps = {
    ...
    data: generateCountriesData(keys, { size: 20 }) as BarDatum[],
    indexBy: 'country',
    keys,
    padding: 0.2,
...
export const Stacked: Story = {
    render: () => <div {...commonProps}></div>,
}

// export const StackedBigData: Story = {
//     render: () => (
//         <ResponsiveBarCanvas
//             {...commonProps}
//             data={generateCountriesData(keys, { size: 1000 }) as BarDatum[]}
//             axisRight={{
//                 legend: 'USERS',
...
// // @ts-ignore
// import { BarCanvas, BarCanvasLayer, BarDatum, canvasDefaultProps } from 'packages/bar/src'
