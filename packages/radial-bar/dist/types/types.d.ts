...
import { Theme, Box, Dimensions, MotionProps, PropertyAccessor, ValueFormat, SvgDefsAndFill } from '@nivo/core';
...
export type RadialBarSvgProps<D extends RadialBarDatum = RadialBarDatum> = Partial<RadialBarCommonProps<D>> & RadialBarDataProps<D> & Dimensions & MotionProps & SvgDefsAndFill<D>;
