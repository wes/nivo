...
export type BulletSvgProps = Partial<CommonBulletProps> & Dimensions & BulletHandlers & MotionProps & {
    data: Datum[];
};
...
export type BulletItemProps = Omit<CommonBulletProps, 'outerWidth' | 'outerHeight' | 'margin' | 'spacing' | 'role' | 'minValue' | 'maxValue' | 'measureSize' | 'markerSize' | 'theme' | 'isInteractive'> & BulletHandlers & EnhancedDatum & MotionProps & Point & {
